...
2. `docs/03_handoff/03_session-handoff-2026-03-15-final.md` — 最新の引き継ぎ
...
## 03_handoff（引き継ぎ）
- **`03_session-handoff-2026-03-15-final.md`** — 最新引き継ぎ（まずこれを読む）
- `02_session-handoff-2026-03-15.md` — 中間版
